...
PRELEARNED_SPECSTR = "prelearned_specstr"

# Enumerations of models.
AUTOENCODER_MODELS = [SPECS_AUTOENCODER]
CLASSIFICATION_MODELS = [SPECSTR, PRELEARNED_SPECSTR, PURE_SPECSTR]
SPECS_MODELS = [SPECSTR, PRELEARNED_SPECSTR, PURE_SPECSTR, SPECS_AUTOENCODER]
