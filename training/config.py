...
AVAILABLE_MODELS = [PURE_SPECSTR, SPECSTR, SPECS_AUTOENCODER, PRETRAINED_SPECSTR, RAWTR, FEAMLP]
AUTOENCODER_MODELS = [SPECS_AUTOENCODER]
PRETRAINED_MODELS = [PRETRAINED_SPECSTR]
CLASSIFICATION_MODELS = [SPECSTR, PRETRAINED_SPECSTR, PURE_SPECSTR, RAWTR, FEAMLP]
SPECS_MODELS = [SPECSTR, PRETRAINED_SPECSTR, PURE_SPECSTR, SPECS_AUTOENCODER]
RAW_AUDIO_MODELS = [RAWTR]
