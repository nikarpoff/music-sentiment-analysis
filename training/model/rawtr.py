...
class TinyRawAudioTransformer(nn.Module):
    def __init__(self, output_channels: int, dropout=0.2, device='cuda'):
        ...
        # Model params
        CNN_UNITS = [128, 256, 512, 512, 1024, 512, 256, 256, 256, 128]
        CNN_KERNELS = [7, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3]
        CNN_STRIDES = [5, 3, 3, 2, 2, 2, 2, 2]
...
class RawAudioTransformer(nn.Module):
    def __init__(self, output_channels: int, dropout=0.2, device='cuda'):
        ...
        # Model params
        CNN_UNITS = [128, 256, 512, 512, 256, 256]
        CNN_KERNELS = [7, 3, 3, 3, 3, 3]
        CNN_STRIDES = [3, 2, 2, 2, 2, 2]
        CNN_PADDINGS = [0] * len(CNN_UNITS)
        RNN_UNITS = 256
        RNN_LAYERS = 2
        TRANSFORMER_DEPTH = 256
